...
/// Every bundled food has a specific USDA record or a deliberately selected,
/// clearly labeled representative estimate. Custom foods can use a manual label.
/// Historical logs retain the nutrition snapshot captured when they were saved.
/// Generated by Scripts/build_solids_nutrition_catalog.rb from official USDA FoodData Central data.
/// All values are per 100 grams and include all eight nutrients tracked by the app.
...
enum SolidsNutritionCatalog {
    ...
    static func reference(foodID: String) -> SolidNutritionReference? {
        ...
        case "broccoli-rabe":
            reference("169967", "Representative USDA estimate for Broccoli rabe: Broccoli, cooked, boiled, drained, without salt", 35.0, 2.38, 0.41, 3.3, 0.67, 0.45, 40.0, 64.9, portions: [:])
        ...
        case "butternut-squash":
            reference("169293", "Representative USDA estimate for Butternut squash: Squash, winter, acorn, cooked, baked, without salt", 56.0, 1.12, 0.14, 4.4, 0.93, 0.17, 44.0, 10.8, portions: [:])
        case "cabbage":
        ...
        case "green-cabbage":
            reference("169976", "Representative USDA estimate for Green cabbage: Cabbage, cooked, boiled, drained, without salt", 23.0, 1.27, 0.06, 1.9, 0.17, 0.2, 48.0, 37.5, portions: [:])
        case "green-onion":
        ...
        case "napa-cabbage":
            reference("169976", "Representative USDA estimate for Napa cabbage: Cabbage, cooked, boiled, drained, without salt", 23.0, 1.27, 0.06, 1.9, 0.17, 0.2, 48.0, 37.5, portions: [:])
        case "nopales":
        ...
        case "purple-cabbage":
            reference("169976", "Representative USDA estimate for Purple cabbage: Cabbage, cooked, boiled, drained, without salt", 23.0, 1.27, 0.06, 1.9, 0.17, 0.2, 48.0, 37.5, portions: [:])
        case "radicchio":
        ...
        case "snap-pea":
            reference("170420", "Representative USDA estimate for Snap pea: Peas, green, cooked, boiled, drained, without salt", 84.0, 5.36, 0.22, 5.5, 1.54, 1.19, 27.0, 14.2, portions: [:])
        ...
        case "yellow-squash":
            reference("169292", "Representative USDA estimate for Yellow squash: Squash, summer, zucchini, includes skin, cooked, boiled, drained, without salt", 15.0, 1.14, 0.36, 1.0, 0.37, 0.33, 18.0, 12.9, portions: [:])
        case "yucca-root":
        ...
        case "semolina":
            reference("171659", "Representative USDA estimate for Semolina: Cereals, farina, enriched, assorted brands including CREAM OF WHEAT, quick (1-3 minutes), cooked with water, without salt", 55.0, 1.82, 0.34, 0.8, 5.33, 0.23, 97.0, 0.0, portions: [:])
        case "sorghum":
        ...
        case "baked-potato":
            reference("2709383", "Potato, baked, NFS", 93.0, 1.95, 0.1, 1.5, 0.35, 0.29, 5.0, 12.7, portions: [:])
        case "bean-burger":
            reference("2707409", "Bean cake", 414.0, 5.8, 21.4, 3.0, 2.58, 0.53, 15.0, 0.3, portions: [:])
        case "bean-dip":
        ...
        case "fruit-smoothie-bowl":
            reference("2705513", "Fruit smoothie, NFS", 66.0, 2.32, 1.1, 1.1, 0.19, 0.37, 80.0, 9.5, portions: [:])
        case "gnocchi":
        ...
        case "oat-pancake":
            reference("2708309", "Pancakes, whole grain", 273.0, 7.86, 12.3, 3.2, 3.15, 1.08, 138.0, 0.0, portions: [:])
