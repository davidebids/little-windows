...
final class ProfileService: ObservableObject {
    ...
    private func deleteProfileScopedRecords(profileID: UUID, context: ModelContext) {
        ...
        deleteProfileScopedRecords(of: MedicationPlanRevision.self, profileID: profileID, context: context)
        deleteProfileScopedRecords(of: MedicationReconciliation.self, profileID: profileID, context: context)
        deleteProfileScopedRecords(of: MedicationRefillTask.self, profileID: profileID, context: context)
        ...
        deleteProfileScopedRecords(of: HouseholdAttentionAcknowledgement.self, profileID: profileID, context: context)
        deleteProfileScopedRecords(of: HouseholdAttentionClaim.self, profileID: profileID, context: context)
        deleteProfileScopedRecords(of: CaregiverHandoffNote.self, profileID: profileID, context: context)
        deleteProfileScopedRecords(of: AppointmentFollowUp.self, profileID: profileID, context: context)
