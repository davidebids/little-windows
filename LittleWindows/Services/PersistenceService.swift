...
enum PersistenceService {
    ...
    static let modelTypes: [any PersistentModel.Type] = [
            ...
            MedicationPlanRevision.self,
            MedicationReconciliation.self,
            MedicationRefillTask.self,
            MedicationDoseRecord.self,
            MedicationSupplyLog.self,
            DoctorAppointment.self,
            AppointmentFollowUp.self,
            HouseholdAttentionAcknowledgement.self,
            HouseholdAttentionClaim.self,
            CaregiverHandoffNote.self,
            FamilyCaregiverIdentity.self,
            MilestoneEntry.self,
            ...
            PackingBag.self,
            PackingItem.self,
            TripItineraryChoiceGroup.self,
            TripItineraryItem.self,
            TripItineraryLink.self,
            FoodItem.self,
