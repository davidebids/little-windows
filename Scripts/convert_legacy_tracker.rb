    ...
    details = items.map do |item|
      {
        ...
        "amountOffered" => item["amountOffered"],
        "amountEaten" => item["amountEaten"],
        "portionUnit" => item["portionUnitRawValue"],
        "consumptionEstimate" => item["consumptionEstimateRawValue"],
        "nutritionSnapshot" => item["nutritionSnapshotJSON"]&.then { |value| JSON.parse(value) },
